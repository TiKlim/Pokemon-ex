...
public class CharmanderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.charmander_activity);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CharmanderActivity.this, Squirtle.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CharmanderActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CharmanderActivity.this, BulbasaurActivity.class);
                startActivity(intent);
            }
        });
    }
