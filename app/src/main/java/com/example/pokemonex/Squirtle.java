...
public class Squirtle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.squirtle_activity);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Squirtle.this, Butterfree.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Squirtle.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Squirtle.this, CharmanderActivity.class);
                startActivity(intent);
            }
        });
    }
